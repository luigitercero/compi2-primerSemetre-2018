...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Tue Mar 06 17:43:32 CST 2018
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		String a = (String)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-4)).value;
                ...
                try {
                  com.Navegador.JS.JS c = new  com.Navegador.JS.JS(a);
                    this.parser.chtml.enlazarObservador(c.js);
                    c.js.agregarComponenteCSSi(this.parser.chtml.componetesCSSI);
		...
		String b = (String)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		a.addText(b); 
                this.parser.chtml.notificar(a.id, "listo"); this.parser.chtml.componetesCSSI.add(a); RESULT = a;
              CUP$parser$result = parser.getSymbolFactory().newSymbol("cuerpoTerminal",13, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-4)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
