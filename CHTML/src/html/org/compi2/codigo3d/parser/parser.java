...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu Mar 01 18:44:35 CST 2018
  */
...
public ArrayList<org.compi2.Interprete.CSS.ID.CSS > css = new ArrayList<org.compi2.Interprete.CSS.ID.CSS >();
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		String a = (String)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-4)).value;
                ...
                try {
                  c = new CompilarCSS(a);
                  this.parser.css.add(c.getParser().css);
                } catch (Exception e) {
		...
		int cright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).right;
		String c = (String)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		a.addAtributo(b,c,this.parser.css); 
