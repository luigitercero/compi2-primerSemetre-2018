...
<YYINITIAL> "<fin-cjs"        { /*System.out.println("    FINCJS");    */return new Symbol(sym.FINCJS     , yyline, yycolumn, yytext()); }
<YYINITIAL> "<cuerpo"         { /*System.out.println("    cuerpo");    */return new Symbol(sym.CUERPO     , yyline, yycolumn, yytext()); }
<YYINITIAL> "<fin-cuerpo"     { /*System.out.println("    FINcuerpo"); */return new Symbol(sym.FINCUERPO     , yyline, yycolumn, yytext()); }
