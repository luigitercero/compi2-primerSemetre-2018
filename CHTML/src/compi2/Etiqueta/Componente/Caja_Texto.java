 ...
 * @author luigitercero
 */
public class Caja_Texto extends JLabel implements CSSI, observador.Observable {
    ...
    public Caja_Texto(ArrayList<CSS> css, ArrayList<Observador> observadores, ArrayList<Observador> rutas) {
        super();
        this.setSize(10, 10);
