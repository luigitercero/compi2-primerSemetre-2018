 ...
 * @author luigitercero
 */
public class Enlace extends JButton implements CSSI, observador.Observable {
    ...
    public Enlace(ArrayList<CSS> css, ArrayList<Observador> observadores, ArrayList<Observador> rutas) {
        super();
        this.setSize(10, 10);
        ...
        this.setFont(font.deriveFont(atr));
    }
