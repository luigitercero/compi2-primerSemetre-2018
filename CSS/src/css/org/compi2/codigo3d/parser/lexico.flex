...
<YYINITIAL> {MENORQUE}         { System.out.println("MENORQUE");return new Symbol(sym.MENORQUE       , yyline, yycolumn, null); }
<YYINITIAL> {IGUAL}            { System.out.println("IGUAL");return new Symbol(sym.IGUAL	      , yyline, yycolumn, null); }
<YYINITIAL> {PUNTOCOMA}        { System.out.println("PUNTOCOMA");return new Symbol(sym.PUNTOCOMA      , yyline, yycolumn, null); }
<YYINITIAL> {PAREA}            { System.out.println("PAREA");return new Symbol(sym.PAREA	      , yyline, yycolumn, null); }
<YYINITIAL> {PAREC}            { System.out.println("PAREC");return new Symbol(sym.PAREC	      , yyline, yycolumn, null); }
<YYINITIAL> {MENOS}            { System.out.println("MENOS");return new Symbol(sym.MENOS	      , yyline, yycolumn, null); }
<YYINITIAL> {MAS}              { System.out.println("MAS");return new Symbol(sym.MAS	          , yyline, yycolumn, null); }
<YYINITIAL> {DIV}              { System.out.println("DIV");return new Symbol(sym.DIV	          , yyline, yycolumn, null); }
<YYINITIAL> {POR}              { System.out.println("POR");return new Symbol(sym.POR	          , yyline, yycolumn, null); }
<YYINITIAL> {CORCHA}           { System.out.println("CORCHA");return new Symbol(sym.CORCHA	      , yyline, yycolumn, null); }
<YYINITIAL> {CORCHC}           { System.out.println("CORCHC");return new Symbol(sym.CORCHC	      , yyline, yycolumn, null); }
<YYINITIAL> {DOSPI}            { System.out.println("DOSPI");return new Symbol(sym.DOSPI	      , yyline, yycolumn, null); }
